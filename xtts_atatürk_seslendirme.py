...
def main():
    ...
    xtts_checkpoint = r'C:\Users\tunahan\Desktop\bark\AtatürkEğitilmişModel3\best_model.pth'
    xtts_config = r'C:\Users\tunahan\Desktop\bark\AtatürkEğitilmişModel3\config (1).json'
    xtts_vocab = r'C:\Users\tunahan\Desktop\bark\AtatürkEğitilmişModel3\vocab (1).json'
    speaker_audio_file = r'C:\Users\tunahan\Desktop\bark\ATATÜRK\0902 (1).MP3'
    ...
    while True:
        ...
        output_path = f'C:\\Users\\tunahan\\Desktop\\bark\\output_audio\\genclige_hitabe{i}.wav'
